    ...
    public ExpenseItemsAdapter.ExpenseItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        inflatedView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext,DetailedViewActivity.class);
                i.putExtra("description", mExpensesToShow.get(holder.getAdapterPosition()).getDescription());
        ...
        holder.mDeleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.deleteExpenseWithDescriptionName(mExpensesToShow.get(pos).getDescription());
